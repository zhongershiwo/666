...
extern void Image_Transform();
 float direction_P = 0,direction_I = 0,direction_D = 0;
 int L_pwm = 0,R_pwm =0;

Item_Lib const Page0_Item[] =
{
	"L_pwm",&L_pwm,Int32_t,RW,
	"R_pwm",&R_pwm,Int32_t,RW
};

Item_Lib const Page1_Item[] =
{
	"IMAGE",(void*)Image_Transform,Function,RW
...
Page_Lib const Page[] =
{
	{"Speed", (Item_LibPtr)Page0_Item, Page0_Item_Max},
	{"FUN", (Item_LibPtr)Page1_Item, Page1_Item_Max},
	{"PID", (Item_LibPtr)Page2_Item, Page2_Item_Max}
};
